...
import unittest
import time
from common import HTMLTestRunner_01  # from common import HTMLTestRunner
...
def run_case(all_case, reportName="report"):
    ...
    runner = HTMLTestRunner_01.HTMLTestRunner(stream=fp,
                                           title=u'API-自动化测试报告：',
                                           description=u'用例执行情况（zhanglu1258@foxmail.com）：')
